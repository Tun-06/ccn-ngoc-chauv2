    ...
    <section class="hero-slider" id="hero-slider">
        <div class="slider-wrapper">
            <div class="slide active" id="slide-1">
                <img src="<?php echo get_template_directory_uri(); ?>/img-slide/46.png" alt="Cụm Công Nghiệp Ngọc Châu - Cổng chính" class="slide-img">
            </div>
            ...
            <div class="slide" id="slide-4">
                <img src="<?php echo get_template_directory_uri(); ?>/img-slide/45.png" alt="Cụm Công Nghiệp Ngọc Châu - Phối cảnh đêm" class="slide-img">
            </div>
    ...
    <section class="stats-section" id="stats-section">
        ...
        <div class="stats-container">
            <div class="stats-header">
                <h2 class="stats-title" id="stats-title"><?php function_exists('pll__') ? pll_e('CÁC CON SỐ VỀ NGỌC CHÂU') : print('CÁC CON SỐ VỀ NGỌC CHÂU'); ?></h2>
            </div>
            <div class="stats-grid">
                ...
                <div class="stat-card" id="stat-scale">
                    ...
                    <p class="stat-label"><?php function_exists('pll__') ? pll_e('Quy mô dự án (ha)') : print('Quy mô dự án (ha)'); ?></p>
                ...
                <div class="stat-card" id="stat-duration">
                    ...
                    <p class="stat-label"><?php function_exists('pll__') ? pll_e('Thời gian hoạt động<br>của dự án') : print('Thời gian hoạt động<br>của dự án'); ?></p>
